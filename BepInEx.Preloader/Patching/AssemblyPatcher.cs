...
namespace Zwojnicow.Preloader.Patching
{
	/// <summary>
	...
	public static class AssemblyPatcher
	{
		...
		private static readonly string DumpedAssembliesPath = Utility.CombinePaths(Paths.ZwojnicowRootPath, "DumpedAssemblies", Paths.ProcessName);
		...
		public static void PatchAndLoad(params string[] directories)
		{
			...
			{
				Logger.LogInfo($"Zwojnicow is about load the following assemblies:\n{string.Join("\n", patchedAssemblies.ToArray())}");
		...
		private static readonly ConfigEntry<bool> ConfigDumpAssemblies = ConfigFile.CoreConfig.Bind(
			...
			false,
			"If enabled, Zwojnicow will save patched assemblies into Zwojnicow/DumpedAssemblies.\nThis can be used by developers to inspect and debug preloader patchers.");
		...
		private static readonly ConfigEntry<bool> ConfigLoadDumpedAssemblies = ConfigFile.CoreConfig.Bind(
			...
			false,
			"If enabled, Zwojnicow will load patched assemblies from Zwojnicow/DumpedAssemblies instead of memory.\nThis can be used to be able to load patched assemblies into debuggers like dnSpy.\nIf set to true, will override DumpAssemblies.");
		...
		private static readonly ConfigEntry<bool> ConfigBreakBeforeLoadAssemblies = ConfigFile.CoreConfig.Bind(
			...
			false,
			"If enabled, Zwojnicow will call Debugger.Break() once before loading patched assemblies.\nThis can be used with debuggers like dnSpy to install breakpoints into patched assemblies before they are loaded.");
